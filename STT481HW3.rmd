...
1. (20 pts) Finish the swirl course xploratory Data Analysis. Finish Section 1-10 (no need to do 11-15).
...
# FINISH SWIRL PUT IN FOLDER AND UPLOAD
...
```{r}
#Compute n and p using simulated data set 
```
...
(c) Use the regsubsets() function to perform best subset selection in order to choose the best model containing the predictors $X,X^2,...,X^10$. What is the best model obtained according to Cp, BIC, and adjustedR2? Show some plots to provide evidence for your answer, and report the coeï¬cients of the best model obtained. Note you will need to use the data.frame() function to create a single data set containing both X and Y .
